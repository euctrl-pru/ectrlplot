...
### Why to use `theme_pru`?

This theme can be used to give to the PRU plots a consistent customized look.

## Examples

The following examples will help you understand how to use `ectrlplot` package and its components.
...
```{r, fig.show='hold', warning=FALSE}
p2 + theme(axis.line.y = ggplot2::element_line(colour = "#D5D5D5",
                                          size = 1.2,
                                          linetype = "solid",
                                          lineend = "round"),
