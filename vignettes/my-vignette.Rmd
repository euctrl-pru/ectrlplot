...
Use the PRU color palette by adding <em>scale_color_pru()</em>, <em>scale_colour_pru()</em> or <em>scale_fill_pru()</em>
...
If you want to modify a single plot's theme use <em>theme()</em>
